package Resources.BTree;

import Resources.BTree.BTree;
...
*/
		...
		st.put("Anna", "hi", "4:20");
		st.put("James", "hi", "4:21");
		st.put("Anna", "How are you?", "4:22");
		st.put("James", "Great! and you?", "4:23");
		st.put("Anna", "Programming, and is boring AF", "4:24");
		
		System.out.print(st.search("HI"));
		System.out.print(st.search("Anna"));
		//st.put("Anna", "hi", "4:33");
		//st.put("Anna", "se van a quedar en datos", "5:55");
